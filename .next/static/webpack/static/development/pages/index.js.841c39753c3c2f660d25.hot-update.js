...
function PartyBackground() {
  ...
  var createBall = function createBall() {
    var ballCss = Object(_emotion_core__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject(), rnd(1, 2), rnd(1, 2), Math.random() * (windowWidth - 2), Math.random() * (windowHeight - 2), colors[Math.floor(Math.random() * colors.length)], Math.random(), animation[rnd(0, 1)]);
...
//# sourceMappingURL=index.js.841c39753c3c2f660d25.hot-update.js.map